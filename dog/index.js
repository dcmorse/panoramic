(() => {
          ...
          var fn = function(acc) {
            return function(v) {
              ...
              if (acc instanceof Left && v2 instanceof Left) {
                return new Left(append5(acc.value0)(v2.value0));
              }
              ;
  ...
  var show22 = /* @__PURE__ */ show(/* @__PURE__ */ showMaybe(/* @__PURE__ */ showRecord2(/* @__PURE__ */ showRecordFieldsCons({
    reflectSymbol: function() {
      return "body";
    }
  ...
  var readForeignFieldsCons2 = /* @__PURE__ */ readForeignFieldsCons(messageIsSymbol);
  var readForeignArray2 = /* @__PURE__ */ readForeignArray(readForeignString);
  var readForeignFieldsCons1 = /* @__PURE__ */ readForeignFieldsCons(statusIsSymbol)(readForeignString)(readForeignFieldsNilRowRo)()();
  var readJSON_2 = /* @__PURE__ */ readJSON_(/* @__PURE__ */ readForeignRecord2(/* @__PURE__ */ readForeignFieldsCons2(readForeignArray2)(readForeignFieldsCons1)()()));
  var readJSON_1 = /* @__PURE__ */ readJSON_(/* @__PURE__ */ readForeignRecord2(/* @__PURE__ */ readForeignFieldsCons2(/* @__PURE__ */ readForeignMapString(readForeignArray2))(readForeignFieldsCons1)()()));
  var show32 = /* @__PURE__ */ show(/* @__PURE__ */ showMaybe(/* @__PURE__ */ showRecord2(/* @__PURE__ */ showRecordFieldsCons(messageIsSymbol)(/* @__PURE__ */ showRecordFieldsConsNil(statusIsSymbol)(showString))(/* @__PURE__ */ showMap(showString)(/* @__PURE__ */ showArray(showString))))));
  var IndexLoad = /* @__PURE__ */ function() {
    function IndexLoad2() {
    }
    ;
    IndexLoad2.value = new IndexLoad2();
    return IndexLoad2;
  }();
  var ViewBreed = /* @__PURE__ */ function() {
    function ViewBreed2(value0) {
      this.value0 = value0;
    }
    ;
    ViewBreed2.create = function(value0) {
      return new ViewBreed2(value0);
    };
    return ViewBreed2;
  }();
  var ViewIndex = /* @__PURE__ */ function() {
    ...
    ;
    ViewIndex2.value = new ViewIndex2();
    return ViewIndex2;
  }();
  var PageDecrement = /* @__PURE__ */ function() {
    function PageDecrement2() {
    }
    ;
    PageDecrement2.value = new PageDecrement2();
    return PageDecrement2;
  }();
  var PageIncrement = /* @__PURE__ */ function() {
    function PageIncrement2() {
    }
    ;
    PageIncrement2.value = new PageIncrement2();
    return PageIncrement2;
  }();
  var showAction = {
    show: function(v) {
      if (v instanceof IndexLoad) {
        return "IndexLoad";
      }
      ;
      if (v instanceof ViewBreed) {
        return "ViewBreed " + show4(v.value0);
      }
      ;
      if (v instanceof ViewIndex) {
        return "ViewIndex";
      }
      ;
      if (v instanceof PageDecrement) {
        return "PageDecrement";
      }
      ;
      if (v instanceof PageIncrement) {
        return "PageIncrement";
      }
      ;
      throw new Error("Failed pattern match at Main (line 66, column 1 - line 71, column 39): " + [v.constructor.name]);
    }
  };
  ...
  var mapIndexBreedMap = function(f) {
  ...
  var render = function(st) {
    if (st.route instanceof Just) {
      return div_(append12([a([onClick(function(v) {
        return ViewIndex.value;
      }), attr2("href")("#")])([text5("all dog breeds")]), h1_([text5(st.route.value0)])])(function() {
        var v = lookup6(st.route.value0)(st.breedImages);
        if (v instanceof Just && v.value0 instanceof Just) {
          var style3 = style("max-height: 200px; width: auto");
          var prevPage = button([onClick(function(v1) {
            return PageDecrement.value;
          }), disabled10(st.paginationOffset <= 0)])([text5("<page")]);
          var nextPage = button([onClick(function(v1) {
            return PageIncrement.value;
          }), disabled10((st.paginationOffset + 20 | 0) >= length(v.value0.value0))])([text5("page>")]);
          var imagesText = function() {
            var $110 = length(v.value0.value0) === 1;
            if ($110) {
              return "image";
            }
            ;
          ...
          var numberOfImagesText = text5(" " + (show1(length(v.value0.value0)) + (" " + (imagesText + " "))));
          var navbar = [div2([style("margin-bottom: 30px")])([prevPage, numberOfImagesText, nextPage])];
          var images2 = map25(function(url) {
            return img([src9(url), style3]);
          })(slice(st.paginationOffset)(st.paginationOffset + 20 | 0)(v.value0.value0));
          var imagesContainer = [div2([style("display: flex; flex-wrap: wrap; justify-content: space-between; gap: 30px 10px")])(images2)];
          return append12(navbar)(imagesContainer);
        }
        ;
        if (v instanceof Just && v.value0 instanceof Nothing) {
          return [text5("Loading image list...")];
        }
        ;
        if (v instanceof Nothing) {
          return [text5("Not yet loading image list (seeing this seems like a bug)...")];
        }
        ;
        throw new Error("Failed pattern match at Main (line 95, column 9 - line 108, column 96): " + [v.constructor.name]);
      }()));
    }
    ;
    if (st.route instanceof Nothing) {
      var colon = function(v) {
        if (v.length === 0) {
          return [];
        }
        ;
      ...
      var breedLink = function(s) {
        return a([onClick(function(v) {
          return new ViewBreed(s);
        }), attr2("href")("#")])([text5(s)]);
      };
      var breedHtml = function(breed) {
        return function(subbreeds) {
          return div_(append12([breedLink(breed)])(append12(colon(subbreeds))(map25(function($145) {
      ...
      return div_([p_([text5(function() {
        var $116 = isNothing(st.indexBreedMap);
        if ($116) {
          return "Loading...";
        }
        ;
        ...
        if (st.indexBreedMap instanceof Nothing) {
          return [text5("Probable parse error loading list of dog breeds!")];
        }
        ;
        if (st.indexBreedMap instanceof Just) {
          return [h1_([text5("Choose Your Dog Breed")]), ul_(map25(function($146) {
            return li_(pure15($146));
          })(mapIndexBreedMap(breedHtml)(st.indexBreedMap.value0)))];
        }
        ;
        throw new Error("Failed pattern match at Main (line 114, column 13 - line 121, column 18): " + [st.indexBreedMap.constructor.name]);
      }())]);
    }
    ;
    throw new Error("Failed pattern match at Main (line 90, column 3 - line 127, column 108): " + [st.route.constructor.name]);
  };
  var initialState = function(v) {
    return {
      indexBreedMap: Nothing.value,
      breedImages: empty3,
      route: Nothing.value,
      paginationOffset: 0
    };
  ...
  var handleAction = function(dictMonadAff) {
    ...
    return function(action2) {
      return discard5(liftEffect7(log2("handleAction triggered with: " + show42(action2))))(function() {
        if (action2 instanceof PageDecrement) {
          return modify_3(function(s) {
            ...
            ;
            $120.paginationOffset = s.paginationOffset - 20 | 0;
            return $120;
          });
        }
        ;
        if (action2 instanceof PageIncrement) {
          return modify_3(function(s) {
            var $123 = {};
            for (var $124 in s) {
            ...
            ;
            $123.paginationOffset = s.paginationOffset + 20 | 0;
            return $123;
          });
        }
        ;
        if (action2 instanceof ViewIndex) {
          return modify_3(function(s) {
            var $126 = {};
            for (var $127 in s) {
            ...
            ;
            $126.route = Nothing.value;
            $126.paginationOffset = 0;
            return $126;
          });
        }
        ;
        if (action2 instanceof ViewBreed) {
          return bind5(get5)(function(st) {
            var ensureLoading = function(v) {
              if (v instanceof Nothing) {
              ...
              ;
              throw new Error("Failed pattern match at Main (line 147, column 9 - line 147, column 45): " + [v.constructor.name]);
            };
            return discard5(modify_3(function(s) {
              ...
              ;
              $131.breedImages = alter3(ensureLoading)(action2.value0)(s.breedImages);
              $131.route = new Just(action2.value0);
              return $131;
            }))(function() {
              var v = lookup6(action2.value0)(st.breedImages);
              if (v instanceof Nothing) {
                return discard5(liftEffect7(log2("cache miss for " + action2.value0)))(function() {
                  return bind5(liftAff2(get3(string)("https://dog.ceo/api/breed/" + (action2.value0 + "/images"))))(function(response) {
                    return discard5(liftEffect7(log2("API response: " + show22(hush(response)))))(function() {
                      var parsed = join3(map111(map26(readJSON_2)(bodyOf))(hush(response)));
                      var images2 = map111(messageOf)(parsed);
                      var updateEntry = function(v1) {
                        if (v1 instanceof Nothing) {
                          return new Just(images2);
                        }
                        ;
                      ...
                      return discard5(liftEffect7(log2("updating image cache urls for " + action2.value0)))(function() {
                        return modify_3(function(s) {
                          var $137 = {};
                          for (var $138 in s) {
                          ...
                          ;
                          $137.breedImages = alter3(updateEntry)(action2.value0)(s.breedImages);
                          return $137;
                        });
                      });
                    });
              ...
              ;
              if (v instanceof Just) {
                return liftEffect7(log2("cache hit for " + action2.value0));
              }
              ;
              throw new Error("Failed pattern match at Main (line 152, column 7 - line 167, column 57): " + [v.constructor.name]);
            });
          });
        }
        ;
        if (action2 instanceof IndexLoad) {
          return discard5(liftEffect7(log2("IndexLoad action triggered, making API request to get the breed list")))(function() {
            return bind5(liftAff2(get3(string)("https://dog.ceo/api/breeds/list/all")))(function(response) {
              var maybeResponse = hush(response);
              return discard5(liftEffect7(log2("API response: " + show22(maybeResponse))))(function() {
                var maybeBody = map111(bodyOf)(maybeResponse);
                var parsed = join3(map111(readJSON_1)(maybeBody));
                return discard5(liftEffect7(log2("status: " + show32(parsed))))(function() {
                  return discard5(modify_3(function(s) {
                    var $142 = {};
                    for (var $143 in s) {
                    ...
                    ;
                    $142.indexBreedMap = map111(messageOf)(parsed);
                    return $142;
                  }))(function() {
                    return liftEffect7(log2("IndexLoad action completed, indexBreedMap is a Just Map"));
                  });
                });
              });
            });
        ...
        ;
        throw new Error("Failed pattern match at Main (line 137, column 3 - line 181, column 83): " + [action2.constructor.name]);
      });
    };
  };
  var component = function(dictMonadAff) {
    return mkComponent({
      ...
      "eval": mkEval({
        ...
        initialize: new Just(IndexLoad.value)
      })
    });
  };
